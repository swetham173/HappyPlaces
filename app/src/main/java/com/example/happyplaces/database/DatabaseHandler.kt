...
class DatabaseHandler(context: Context) :
    ...
    fun updateHappyPlace(happyPlace: HappyPlaceModel): Int {
       ...
       KEY_ID+"="+happyPlace.id,null)
        ...
        //KEY_ID is "_id" and happyPlace.id is 5, then the selection criteria becomes "_id=5",
        // indicating that the database operation should update the row where the "_id" column has a value of 5.
        db.close()
        return success
    }
