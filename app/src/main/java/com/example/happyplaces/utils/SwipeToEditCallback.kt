...
abstract class SwipeToEditCallback(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
    ...
    private val intrinsicWidth = editIcon!!.intrinsicWidth // The intrinsic width is the natural width of the drawable, which is defined in the drawable resource itself.
